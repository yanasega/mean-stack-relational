angular.module('mean.system').controller('StudentInCourseController', ['$scope', '$resource' ,'Global', 'StudentInCourses','$window',function ($scope, $resource ,Global ,Courses ,$window) {
    ...
    $scope.addCourse = function() {
     ...
     $scope.find = function() {
        StudentInCourses.query(function(courses) {
